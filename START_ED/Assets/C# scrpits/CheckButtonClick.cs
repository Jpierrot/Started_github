...
public class CheckButtonClick : MonoBehaviour
{
    ...
    private void Start()
    {
        Trait_Text = Content.GetComponentsInChildren<Text>();
    ...
    public void CheckButtonOnClick_0()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[0].transform.GetChild(0).gameObject.activeSelf==false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[0].text;break;
                    case 2: Trait_text[1].text += Trait_Text[0].text;break;
                    case 3: Trait_text[2].text += Trait_Text[0].text;break;
                }
            }
        }           
    }
    public void CheckButtonOnClick_1()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[1].transform.GetChild(0).gameObject.activeSelf == false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[1].text; break;
                    case 2: Trait_text[1].text += Trait_Text[1].text; break;
                    case 3: Trait_text[2].text += Trait_Text[1].text; break;
                }
            }
        }
    }
    public void CheckButtonOnClick_2()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[2].transform.GetChild(0).gameObject.activeSelf == false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[2].text; break;
                    case 2: Trait_text[1].text += Trait_Text[2].text; break;
                    case 3: Trait_text[2].text += Trait_Text[2].text; break;
                }
            }
        }
    }
    public void CheckButtonOnClick_3()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[3].transform.GetChild(0).gameObject.activeSelf == false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[3].text; break;
                    case 2: Trait_text[1].text += Trait_Text[3].text; break;
                    case 3: Trait_text[2].text += Trait_Text[3].text; break;
                }
            }
        }
    }
    public void CheckButtonOnClick_4()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[4].transform.GetChild(0).gameObject.activeSelf == false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[4].text; break;
                    case 2: Trait_text[1].text += Trait_Text[4].text; break;
                    case 3: Trait_text[2].text += Trait_Text[4].text; break;
                }
            }
        }
    }
    public void CheckButtonOnClick_5()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[5].transform.GetChild(0).gameObject.activeSelf == false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[5].text; break;
                    case 2: Trait_text[1].text += Trait_Text[5].text; break;
                    case 3: Trait_text[2].text += Trait_Text[5].text; break;
                }
            }
        }
    }
    public void CheckButtonOnClick_6()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[6].transform.GetChild(0).gameObject.activeSelf == false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[6].text; break;
                    case 2: Trait_text[1].text += Trait_Text[6].text; break;
                    case 3: Trait_text[2].text += Trait_Text[6].text; break;
                }
            }
        }
    }
    public void CheckButtonOnClick_7()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[7].transform.GetChild(0).gameObject.activeSelf == false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[7].text; break;
                    case 2: Trait_text[1].text += Trait_Text[7].text; break;
                    case 3: Trait_text[2].text += Trait_Text[7].text; break;
                }
            }
        }
    }
    public void CheckButtonOnClick_8()
    {
        if (ButtonCount < 3)
        {
            if (Check_Button[8].transform.GetChild(0).gameObject.activeSelf == false)
            {
                ...
                switch (ButtonCount)
                {
                    case 1: Trait_text[0].text += Trait_Text[8].text; break;
                    case 2: Trait_text[1].text += Trait_Text[8].text; break;
                    case 3: Trait_text[2].text += Trait_Text[8].text; break;
                }
            }
        }
    }
